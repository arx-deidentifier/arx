...
To build only the core code using Maven, set the system property `core` to `true`. This will build a platform independant jar with the arx main code module and no GUI components. For example,
