...
public class TestDataTransformationsFromFileTCloseness extends TestDataTransformationsFromFileAbstract {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricDMStar()).addCriterion(new EqualDistanceTCloseness("occupation", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "occupation",
                                     "data/adult.csv",
                                     3.11880088E8d,
                                     new int[] { 1, 4, 1, 0, 3, 2, 2, 1 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricDMStar()).addCriterion(new EqualDistanceTCloseness("occupation", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "occupation",
                                     "data/adult.csv",
                                     3.11880088E8d,
                                     new int[] { 1, 4, 1, 0, 3, 2, 2, 1 },
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricEntropy()).addCriterion(new KAnonymity(100)), "occupation", "data/adult.csv", 390436.40440636495d, new int[] { 1,
                        4, 1, 0, 3, 1, 2, 1}, false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricDMStar()).addCriterion(new EqualDistanceTCloseness("occupation", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "occupation",
                                     "data/adult.csv",
                                     4.56853172E8d,
                                     new int[] { 1, 4, 1, 1, 3, 2, 2, 1 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricDMStar()).addCriterion(new EqualDistanceTCloseness("occupation", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "occupation",
                                     "data/adult.csv",
                                     4.56853172E8d,
                                     new int[] { 1, 4, 1, 1, 3, 2, 2, 1 },
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricEntropy()).addCriterion(new KAnonymity(100)), "occupation", "data/adult.csv", 390436.40440636495d, new int[] { 1,
                        ...
                        2,
                        1 }, true) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricEntropy()).addCriterion(new EqualDistanceTCloseness("Highest level of school completed", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "Highest level of school completed",
                                     "data/atus.csv",
                                     5267622.788737194d,
                                     new int[] { 0, 5, 0, 1, 2, 2, 2, 2 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricEntropy()).addCriterion(new EqualDistanceTCloseness("Highest level of school completed", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "Highest level of school completed",
                                     "data/atus.csv",
                                     5267622.788737194d,
                                     new int[] { 0, 5, 0, 1, 2, 2, 2, 2 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricEntropy()).addCriterion(new EqualDistanceTCloseness("Highest level of school completed", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "Highest level of school completed",
                                     "data/atus.csv",
                                     5760138.103541854d,
                                     new int[] { 0, 5, 0, 2, 2, 2, 2, 2 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricEntropy()).addCriterion(new EqualDistanceTCloseness("Highest level of school completed", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "Highest level of school completed",
                                     "data/atus.csv",
                                     5760138.103541854d,
                                     new int[] { 0, 5, 0, 2, 2, 2, 2, 2 },
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new KAnonymity(5)), "RAMNTALL", "data/cup.csv", 1407619.3716609066d, new int[] { 3,
                        ...
                        4,
                        4 }, false) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new KAnonymity(100)), "RAMNTALL", "data/cup.csv", 1509368.88828439d, new int[] { 3,
                        4,
                        1,
                        1,
                        0,
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new KAnonymity(5)), "RAMNTALL", "data/cup.csv", 1407669.5060439722d, new int[] { 3,
                        ...
                        4,
                        2 }, true) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new KAnonymity(100)), "RAMNTALL", "data/cup.csv", 1516301.8703843413d, new int[] { 3,
                        4,
                        1,
                        1,
                        0,
                ...
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricDMStar()).addCriterion(new KAnonymity(100)),
                                     ...
                                     new int[] { 0, 2, 3, 3, 0, 2, 2},
                                     true) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new EqualDistanceTCloseness("EDUC", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "EDUC",
                                     "data/ihis.csv",
                                     1.4719292081181683E7d,
                                     new int[] { 0, 0, 0, 3, 4, 2, 0, 1 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.04d, new MetricNMEntropy()).addCriterion(new EqualDistanceTCloseness("EDUC", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "EDUC",
                                     "data/ihis.csv",
                                     1.4719292081181683E7d,
                                     new int[] { 0, 0, 0, 3, 4, 2, 0, 1 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricNMEntropy()).addCriterion(new EqualDistanceTCloseness("EDUC", 0.2d)).addCriterion(new KAnonymity(5)),
                                     "EDUC",
                                     "data/ihis.csv",
                                     1.4719292081181683E7d,
                                     new int[] { 0, 0, 0, 3, 4, 2, 0, 1 },
                                     false) },
                { new TestCaseResult(new ARXConfiguration(0.0d, new MetricNMEntropy()).addCriterion(new EqualDistanceTCloseness("EDUC", 0.2d)).addCriterion(new KAnonymity(100)),
                                     "EDUC",
                                     "data/ihis.csv",
                                     1.4719292081181683E7d,
                                     new int[] { 0, 0, 0, 3, 4, 2, 0, 1 },
