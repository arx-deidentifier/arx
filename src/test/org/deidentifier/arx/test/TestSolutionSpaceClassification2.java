...
public class TestSolutionSpaceClassification2 extends TestAnonymizationAbstract {
    ...
    public static Collection<Object[]> cases() throws IOException {
        return Arrays.asList(new Object[][] {
                { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createEntropyMetric(false)).addCriterion(new EntropyLDiversity("occupation", 5)), "occupation", "../arx-data/data-junit/adult.csv", 228878.2039109517, new int[] { 1, 0, 1, 1, 2, 2, 2, 1 }, false, new int[] {4320, 2246, 369, 3369, 0, 0, 369}) },
                { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createEntropyMetric(false)).addCriterion(new RecursiveCLDiversity("Highest level of school completed", 4d, 5)), "Highest level of school completed", "../arx-data/data-junit/atus.csv", 3536911.5162082445, new int[] { 0, 4, 0, 0, 2, 0, 1, 2 }, true, new int[] {8748, 147, 78, 69, 684, 7917, 78}) },
                ...
                { new ARXAnonymizationTestCase(ARXConfiguration.create(0.05d, Metric.createEntropyMetric(false)).addCriterion(new DPresence(0.0, 0.2, DataSubset.create(Data.create("../arx-data/data-junit/cup.csv", ';'), Data.create("../arx-data/data-junit/cup_subset.csv", ';')))), "RAMNTALL", "../arx-data/data-junit/cup.csv", 128068.07605943311, new int[] { 2, 4, 1, 1, 0, 3, 4 }, false, new int[] {9000, 8992, 1862, 7138, 0, 0, 1862}) },
