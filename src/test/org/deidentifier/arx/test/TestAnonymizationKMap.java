...
public class TestAnonymizationKMap extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() throws IOException {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.05d, Metric.createAECSMetric()).addCriterion(new KMap(20, DataSubset.create(Data.create("./data/adult.csv", ';'), Data.create("./data/adult_subset.csv", ';')))), "occupation", "./data/adult.csv", 11.424242424242424, new int[] { 1, 0, 1, 1, 3, 2, 1, 0 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.05d, Metric.createPrecomputedEntropyMetric(0.1d, true)).addCriterion(new KMap(7, DataSubset.create(Data.create("./data/adult.csv", ';'), Data.create("./data/adult_subset.csv", ';')))), "occupation", "./data/adult.csv", 17075.7181747451, new int[] { 0, 0, 1, 1, 2, 2, 2, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.0d, Metric.createAECSMetric()).addCriterion(new KMap(5, DataSubset.create(Data.create("./data/adult.csv", ';'), Data.create("./data/adult_subset.csv", ';')))), "occupation", "./data/adult.csv", 45.014925373134325, new int[] { 1, 0, 1, 2, 3, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.0d, Metric.createPrecomputedEntropyMetric(0.1d, true)).addCriterion(new KMap(2, DataSubset.create(Data.create("./data/adult.csv", ';'), Data.create("./data/adult_subset.csv", ';')))), "occupation", "./data/adult.csv", 23108.1673304724, new int[] { 1, 0, 1, 1, 3, 2, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.0d, Metric.createPrecomputedEntropyMetric(0.1d, false)).addCriterion(new KMap(10, DataSubset.create(Data.create("./data/adult.csv", ';'), Data.create("./data/adult_subset.csv", ';')))), "occupation", "./data/adult.csv", 30238.2081484441, new int[] { 0, 1, 1, 2, 3, 2, 2, 0 }, false) },
