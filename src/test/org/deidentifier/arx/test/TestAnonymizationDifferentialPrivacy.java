...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              /* 40 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 100, true), "", "./data/fars.csv", "-596021863 / 563640", new int[] { 3, 1, 2, 1, 0, 1, 3, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 10, true), "", "./data/adult.csv", "-18334007 / 94920", new int[] {0, 3, 1, 2, 3, 2, 1, 1, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 10, true), "", "./data/cup.csv", "-5331884279875 / 15795676072", new int[] { 4, 4, 0, 2, 0, 3, 3, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 10, true), "", "./data/fars.csv", "-1458918077 / 3306380", new int[] { 4, 1, 2, 2, 0, 1, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 100, true), "", "./data/adult.csv", "-399231593 / 2335032", new int[] { 1, 3, 0, 2, 2, 1, 1, 1, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 100, true), "", "./data/cup.csv", "-426453329154 / 1303888355", new int[] { 5, 2, 0, 1, 1, 3, 1, 2 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 3d, 1d, 1E-5d, 100, true), "", "./data/fars.csv", "-224272291 / 480928", new int[] { 4, 1, 2, 3, 0, 1, 2, 0 }, false) },
        });
    }
