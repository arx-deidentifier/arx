...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 100, true), "", "./data/adult.csv", "-467828531 / 1260504", new int[] { 0, 4, 0, 2, 2, 0, 1, 0, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 100, true), "", "./data/cup.csv", "-3160402984801 / 5266595796", new int[] { 4, 4, 0, 1, 0, 1, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 100, true), "", "./data/fars.csv", "-14249389599 / 14278880", new int[] { 4, 1, 2, 1, 0, 0, 2, 0 }, false) },
        });
    }
