...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 1d, 0.1d, 1E-5d, 10), "./data/adult.csv", 747.875, new int[] { 0, 3, 1, 2, 3, 2, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 1d, 0.1d, 1E-5d, 10), "./data/adult.csv", 0.6880872033117096, new int[] { 1, 3, 0, 2, 2, 2, 2, 2, 1 }, false) },
                                              /* 20 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 1d, 0.1d, 1E-5d, 10), "./data/adult.csv", 0.589773390862588, new int[] { 0, 3, 0, 2, 2, 1, 2, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 1d, 0.1d, 1E-5d, 10), "./data/adult.csv", 2.1844143E7, new int[] { 1, 1, 1, 1, 3, 2, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 1d, 0.1d, 1E-5d, 10), "./data/adult.csv", 235748.7244642646, new int[] { 0, 3, 0, 1, 2, 2, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 1d, 0.1d, 1E-5d, 10), "./data/cup.csv", 189.03, new int[] { 5, 1, 1, 2, 0, 3, 4, 4 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 1d, 0.1d, 1E-5d, 10), "./data/cup.csv", 0.4208602413896392, new int[] { 4, 3, 0, 1, 0, 3, 2, 2 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 1d, 0.1d, 1E-5d, 10), "./data/cup.csv", 0.6156805467386128, new int[] { 4, 4, 0, 0, 0, 3, 3, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 1d, 0.1d, 1E-5d, 10), "./data/cup.csv", 6.1535014E7, new int[] { 5, 4, 1, 1, 0, 4, 4, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 1d, 0.1d, 1E-5d, 10), "./data/cup.csv", 1279030.0994022028, new int[] { 4, 3, 0, 1, 0, 3, 3, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 1d, 0.1d, 1E-5d, 10), "./data/fars.csv", 1930.6451612903227, new int[] { 4, 2, 3, 3, 1, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 1d, 0.1d, 1E-5d, 10), "./data/fars.csv", 0.3275306089925023, new int[] { 3, 1, 2, 2, 0, 1, 2, 1 }, false) },
                                              /* 30 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 1d, 0.1d, 1E-5d, 10), "./data/fars.csv", 0.49322960178223346, new int[] { 5, 1, 3, 1, 0, 0, 3, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 1d, 0.1d, 1E-5d, 10), "./data/fars.csv", 2.408373474E9, new int[] { 5, 2, 3, 2, 1, 2, 3, 2 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 1d, 0.1d, 1E-5d, 10), "./data/fars.csv", 890773.3686077329, new int[] { 3, 1, 2, 2, 0, 1, 2, 1 }, false) },
        });
    }
