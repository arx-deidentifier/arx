...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              /* 50 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "", "./data/cup.csv", 176.80645161290323, new int[] { 5, 4, 0, 2, 1, 4, 4, 4 }, false, null, new String[] {"INCOME", "GENDER"}) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "", "./data/fars.csv", 336.68548387096774, new int[] { 5, 2, 3, 3, 0, 2, 3, 2 }, false, null, new String[] {"isex", "ihispanic"}) },
