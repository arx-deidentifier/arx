...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "", "./data/adult.csv", 231.53225806451613, new int[] { 0, 4, 1, 2, 3, 2, 2, 2, 0 }, false, null, "salary-class") },
                                              /* 50 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "", "./data/cup.csv", 353.56451612903226, new int[] { 5, 4, 0, 2, 1, 4, 3, 4 }, false, null, "GENDER") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 1), "", "./data/fars.csv", 914.5967741935484, new int[] { 5, 2, 3, 3, 1, 0, 3, 1 }, false, null, "ihispanic") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 10), "", "./data/adult.csv", 232.74193548387098, new int[] { 1, 4, 1, 2, 2, 2, 0, 2, 0 }, false, null, "salary-class") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 10), "", "./data/cup.csv", 353.61290322580646, new int[] { 5, 4, 0, 2, 1, 3, 4, 4 }, false, null, "GENDER") },
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "", "./data/adult.csv", 237.1451612903226, new int[] { 1, 4, 1, 0, 2, 2, 2, 1, 0 }, false, null, "salary-class") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "", "./data/cup.csv", 355.4516129032258, new int[] { 5, 3, 0, 1, 1, 4, 4, 4 }, false, null, "GENDER") },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createClassificationMetric(), 2d, 1d, 1E-5d, 100), "", "./data/fars.csv", 960.0967741935484, new int[] { 5, 1, 2, 3, 1, 0, 3, 0 }, false, null, "ihispanic") },
        });
    }
