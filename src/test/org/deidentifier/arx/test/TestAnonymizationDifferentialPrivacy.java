...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 2d, 1d, 1E-5d, 10, false), "./data/adult.csv", 36.0, new int[] { 0, 3, 0, 2, 3, 2, 2, 1, 1 }, false) },
                                              /* 20 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, false), "./data/adult.csv", -372.6418664280325, new int[] { 0, 3, 0, 1, 3, 1, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 2d, 1d, 1E-5d, 10, false), "./data/adult.csv", -359.69884638737096, new int[] { 0, 4, 0, 1, 1, 2, 2, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 2d, 1d, 1E-5d, 10, false), "./data/adult.csv", -190.85201966572143, new int[] { 0, 3, 1, 1, 2, 2, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 2d, 1d, 1E-5d, 10, false), "./data/adult.csv", -360.9603535634184, new int[] { 0, 3, 1, 1, 1, 2, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 2d, 1d, 1E-5d, 10, false), "./data/cup.csv", 223.0, new int[] { 3, 2, 1, 1, 0, 4, 4, 4 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, false), "./data/cup.csv", -691.6443068409272, new int[] { 4, 3, 0, 2, 0, 4, 3, 2 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 2d, 1d, 1E-5d, 10, false), "./data/cup.csv", -750.7112704918032, new int[] { 4, 4, 0, 1, 0, 3, 2, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 2d, 1d, 1E-5d, 10, false), "./data/cup.csv", -381.19001097958255, new int[] { 3, 4, 1, 1, 0, 4, 3, 4 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 2d, 1d, 1E-5d, 10, false), "./data/cup.csv", -644.8396875772808, new int[] { 4, 3, 0, 1, 0, 3, 2, 3 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 2d, 1d, 1E-5d, 10, false), "./data/fars.csv", 34.0, new int[] { 4, 0, 2, 3, 1, 1, 3, 2 }, false) },
                                              /* 30 */ { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, false), "./data/fars.csv", -1070.2121839621404, new int[] { 4, 1, 3, 2, 0, 1, 2, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createPrecisionMetric(), 2d, 1d, 1E-5d, 10, false), "./data/fars.csv", -1147.6071721311475, new int[] { 2, 0, 3, 3, 0, 1, 3, 0 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createDiscernabilityMetric(), 2d, 1d, 1E-5d, 10, false), "./data/fars.csv", -605.9354050523547, new int[] { 3, 2, 2, 1, 1, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createEntropyMetric(), 2d, 1d, 1E-5d, 10, false), "./data/fars.csv", -1013.242267034075, new int[] { 4, 0, 2, 2, 0, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createAECSMetric(), 2d, 1d, 1E-5d, 100, false), "./data/adult.csv", 144.0, new int[] { 1, 0, 1, 1, 3, 2, 2, 1, 1 }, false) },
                                              /* Data-dependent and reliable differential privacy */
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, true), "", "./data/adult.csv", "-125395891 / 307440", new int[] { 1, 4, 0, 1, 2, 2, 2, 0, 1 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, true), "", "./data/cup.csv", "-106680036516513 / 145580696800", new int[] { 3, 4, 0, 2, 0, 3, 2, 4 }, false) },
                                              { new ARXAnonymizationTestCase(createDataDependentConfiguration(Metric.createLossMetric(), 2d, 1d, 1E-5d, 10, true), "", "./data/fars.csv", "-3534059 / 3416", new int[] { 3, 0, 2, 3, 0, 0, 2, 1 }, false) },
        });
    }
    ...
    private static ARXConfiguration createDataDependentConfiguration(Metric<?> metric, double epsilon, double searchBudget, double delta, int steps, boolean reliable) {
        ExponentialMechanismReliable.denominatorCache = new HashMap<>();
        ExponentialMechanismReliable.numeratorCache = new HashMap<>();
