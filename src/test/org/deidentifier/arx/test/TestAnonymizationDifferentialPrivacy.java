...
public class TestAnonymizationDifferentialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createAECSMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 0.1d, 100, true)), "./data/adult.csv", 346.6896551724138, new int[] { 0, 0, 1, 2, 3, 1, 2, 2, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createLossMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 0.1d, 100, true)), "./data/adult.csv", 0.235030808021224, new int[] { 0, 3, 0, 0, 3, 2, 2, 1, 1 }, false) },
                                              /* 20 */ { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPrecisionMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 0.1d, 100, true)), "./data/adult.csv", 0.3840612544113639, new int[] { 0, 4, 0, 0, 3, 2, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createDiscernabilityMetric()).addCriterion(new EDDifferentialPrivacy(0.9d, 1E-5d, 0.1d, 100, true)), "./data/adult.csv", 2.2603229E7, new int[] { 0, 1, 1, 2, 3, 2, 2, 1, 1 }, false) },
