...
public class TestAnonymizationTCloseness extends TestAnonymizationAbstract {
    ...
    public static Collection<Object[]> cases() {
        ...
        /* 00*/ { new ARXTestCase(ARXConfiguration.create(0.04d, Metric.createDMStarMetric()).addCriterion(new EqualDistanceTCloseness("occupation", 0.2d)).addCriterion(new KAnonymity(5)), "occupation", "../arx-data/data-junit/adult.csv", 3.11880088E8d, new int[] { 1, 4, 1, 0, 3, 2, 2, 1 }, false) }, 
        ...
        /* 10*/ { new ARXTestCase(ARXConfiguration.create(0.04d, Metric.createEntropyMetric()).addCriterion(new KAnonymity(5)), "occupation", "../arx-data/data-junit/adult.csv", 390436.40440636495d, new int[] { 1, 4, 1, 0, 3, 1, 2, 1 }, true) },
        ...
        /* 20*/ { new ARXTestCase(ARXConfiguration.create(0.0d, Metric.createNMEntropyMetric()).addCriterion(new KAnonymity(5)), "RAMNTALL", "../arx-data/data-junit/cup.csv", 2023751.2434216265d, new int[] { 4, 4, 1, 2, 1, 4, 4 }, false) }, 
        ...
        { new ARXTestCase(ARXConfiguration.create(0.04d, Metric.createNMEntropyMetric()).addCriterion(new KAnonymity(5)), "RAMNTALL", "../arx-data/data-junit/cup.csv", 1407669.506043972d, new int[] { 3, 4, 1, 0, 0, 4, 2 }, true) }, 
        ...
        /* 30*/ { new ARXTestCase(ARXConfiguration.create(0.04d, Metric.createNMEntropyMetric()).addCriterion(new EqualDistanceTCloseness("EDUC", 0.2d)).addCriterion(new KAnonymity(5)), "EDUC", "../arx-data/data-junit/ihis.csv", 1.4719292081181683E7d, new int[] { 0, 0, 0, 3, 4, 2, 0, 1 }, false) }, 
