...
public class TestExecutionTimeKAnonymity extends AbstractTestExecutionTime {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createAECSMetric()).addCriterion(new KAnonymity(5)), "../arx-data/data-junit/cup.csv", 1764006.4033760305, new int[] { 2, 4, 0, 1, 0, 4, 4, 4 }, false) },
//                                             
