...
public class TestAnonymizationFinancialPrivacy extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() throws IOException {
        return Arrays.asList(new Object[][] {
                                              /* 0 */{ new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistNoAttackPrivacy(DataSubset.create(Data.create("./data/adult.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/adult_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig1()), "occupation", "./data/adult.csv", 2974380.2122727702, new int[] { 1, 3, 1, 1, 3, 2, 1, 1 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistNoAttackPrivacy(DataSubset.create(Data.create("./data/adult.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/adult_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig3()), "occupation", "./data/adult.csv", 289703.2817537615, new int[] { 0, 1, 1, 2, 3, 2, 1, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistNoAttackPrivacy(DataSubset.create(Data.create("./data/adult.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/adult_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig2()), "occupation", "./data/adult.csv", 2042388.7119921802, new int[] { 1, 3, 0, 1, 3, 0, 0, 1 }, true) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createEntropyBasedInformationLossMetric()).addCriterion(new FinancialProsecutorNoAttackPrivacy()), "Highest level of school completed", "./data/atus.csv", 111422.02307271949, new int[] { 0, 3, 0, 0, 0, 0, 0, 1 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.0d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialProsecutorPrivacy()).setFinancialConfiguration(getConfig3()), "Highest level of school completed", "./data/atus.csv", 4.095311485910724E7, new int[] { 0, 0, 1, 2, 2, 2, 2, 1 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialProsecutorNoAttackPrivacy()).setFinancialConfiguration(getConfig3()), "Highest level of school completed", "./data/atus.csv", 1.0594182696792958E7, new int[] { 2, 2, 0, 0, 0, 0, 0, 1 }, true) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialProsecutorNoAttackPrivacy()).setFinancialConfiguration(getConfig3()), "istatenum", "./data/fars.csv", 3919009.501300308, new int[] { 2, 0, 0, 3, 0, 0, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialProsecutorNoAttackPrivacy()).setFinancialConfiguration(getConfig2()), "EDUC", "./data/ihis.csv", 3.228463008839508E8, new int[] { 0, 2, 0, 0, 1, 0, 1, 0 }, false) },
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistPrivacy(DataSubset.create(Data.create("./data/ihis.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/ihis_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig2()), "EDUC", "./data/ihis.csv", 5.12685882625751E7, new int[] { 0, 2, 2, 1, 2, 0, 1, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.0d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistNoAttackPrivacy(DataSubset.create(Data.create("./data/ihis.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/ihis_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig1()), "EDUC", "./data/ihis.csv", 8.993970011390185E7, new int[] { 0, 0, 0, 3, 4, 2, 0, 1 }, false) },
                                              ...
                                              /* 50 */{ new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialProsecutorNoAttackPrivacy()).setFinancialConfiguration(getConfig2()), "EDUC", "./data/ihis.csv", 3.5652925691206706E8, new int[] { 0, 2, 2, 2, 0, 0, 1, 0 }, true) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPublisherPayoutMetric(false)).addCriterion(new FinancialJournalistNoAttackPrivacy(DataSubset.create(Data.create("./data/ihis.csv", StandardCharsets.UTF_8, ';'), Data.create("./data/ihis_subset.csv", StandardCharsets.UTF_8, ';')))).setFinancialConfiguration(getConfig3()), "EDUC", "./data/ihis.csv", 1.3085931288760101E7, new int[] { 5, 0, 0, 1, 4, 0, 0, 0 }, true) },
