...
public class TestAnonymizationProfitability extends AbstractAnonymizationTest {
    ...
    public static Collection<Object[]> cases() throws IOException {
        return Arrays.asList(new Object[][] {
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createEntropyBasedInformationLossMetric()).addPrivacyModel(new ProfitabilityProsecutorNoAttack()), "Highest level of school completed", "./data/atus.csv", 111422.02307271949, new int[] { 0, 3, 0, 0, 0, 0, 0, 1 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPrecomputedEntropyMetric(0.1d, false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()), "Highest level of school completed", "./data/atus.csv", 2648409.8742651404, new int[] { 0, 3, 0, 1, 1, 1, 2, 1 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig3()), "Highest level of school completed", "./data/atus.csv", 1.0594182696792958E7, new int[] { 2, 2, 0, 0, 0, 0, 0, 1 }, true) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig3()), "istatenum", "./data/fars.csv", 3919009.501300308, new int[] { 2, 0, 0, 3, 0, 0, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPublisherPayoutMetric(false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig2()), "EDUC", "./data/ihis.csv", 3.228463008839508E8, new int[] { 0, 2, 0, 0, 1, 0, 1, 0 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPrecomputedEntropyMetric(0.1d, true)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig3()), "EDUC", "./data/ihis.csv", 5339062.508844286, new int[] { 0, 0, 0, 3, 0, 1, 0, 1 }, false) },
                                              ...
                                              { new ARXAnonymizationTestCase(ARXConfiguration.create(1d, Metric.createPublisherPayoutMetric(false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig1()), "EDUC", "./data/ihis.csv", 6.388610340766058E8, new int[] { 1, 2, 2, 1, 2, 0, 1, 0 }, false) },
                                              ...
                                              /* 50 */{ new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createPublisherPayoutMetric(false)).addPrivacyModel(new ProfitabilityProsecutorNoAttack()).setCostBenefitConfiguration(getConfig2()), "EDUC", "./data/ihis.csv", 3.5652925691206706E8, new int[] { 0, 2, 2, 2, 0, 0, 1, 0 }, true) },
