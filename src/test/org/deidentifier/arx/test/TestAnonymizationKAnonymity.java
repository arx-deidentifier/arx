...
public class TestAnonymizationKAnonymity extends TestAnonymizationAbstract {
    ...
    public static Collection<Object[]> cases() {
        return Arrays.asList(new Object[][] {
                ...
                { new ARXAnonymizationTestCase(ARXConfiguration.create(0.04d, Metric.createEntropyMetric(false)).addCriterion(new KAnonymity(100)), "../arx-data/data-junit/cup.csv", 2001343.4737485605, new int[] { 3, 4, 1, 1, 0, 1, 2, 1 }, false) },
