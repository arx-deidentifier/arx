...
public class ViewMaskingConfiguration implements IView {
	...
	private static final String[] COMBO1_MASKINGTYPES = new String[] {
			Resources.getMessage("MaskingConfigurationView.10"), Resources.getMessage("MaskingConfigurationView.1"),
			Resources.getMessage("MaskingConfigurationView.2"), Resources.getMessage("MaskingConfigurationView.3"),
			Resources.getMessage("MaskingConfigurationView.4") };

	/** Resource */
	private static final MaskingType[] COMBO1_TYPES = new MaskingType[] { MaskingType.SUPPRESSED,
	...
	public ViewMaskingConfiguration(final Composite parent, final Controller controller) {
		...
		kLabel.setText(Resources.getMessage("MaskingConfigurationView.0"));
		...
		cmbMasking.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(final SelectionEvent arg0) {
				if ((cmbMasking.getSelectionIndex() != -1) && (attribute != null)) {
					...
					Set<String> identifyingAttributes = controller.getModel().getInputDefinition()
		...
		labelStrLength.setText(Resources.getMessage("MaskingConfigurationView.5"));
		...
		labelProbDist.setText(Resources.getMessage("MaskingConfigurationView.6"));
	...
	public void update(final ModelEvent event) {
		...
		// gets called whenever a distribution is added/deleted, refreshes
		// ComboButton and selects appropriate distribution
