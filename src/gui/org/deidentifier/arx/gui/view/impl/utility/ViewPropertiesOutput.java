    ...
    protected void doUpdate(ModelPart part) {
        ...
        if (node.getAnonymity() == Anonymity.ANONYMOUS) {
            ...
            if (context.config.containsCriterion(EDDifferentialPrivacy.class)) {
                ...
                new Property(n, Resources.getMessage("PropertiesView.142"), new String[] { SWTUtil.getPrettyString(criterion.getEpsilonAnon()+criterion.getEpsilonSearch())}); //$NON-NLS-1$
