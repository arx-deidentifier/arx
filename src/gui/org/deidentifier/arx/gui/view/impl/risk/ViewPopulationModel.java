...
import org.deidentifier.arx.gui.model.ModelPopulation.Region;
...
public class ViewPopulationModel implements IView {
    ...
    private void create(final Composite parent) {
        ...
        list.addSelectionListener(new SelectionAdapter(){
            public void widgetSelected(SelectionEvent arg0) {
                if (model.getInputConfig() != null && model.getInputConfig().getInput() != null &&
                    ...
                    model.getPopulationModel().setRegion(selected, model.getInputConfig().getInput().getHandle());
                    controller.update(new ModelEvent(ViewPopulationModel.this, ModelPart.POPULATION_MODEL, model.getPopulationModel()));
        ...
        text.addModifyListener(new ModifyListener(){
            public void modifyText(ModifyEvent arg0) {
                ...
                if (value == model.getPopulationModel().getSampleFraction()) {
                    return;
                }
    ...
    private void update() {
        ...
        text.setText(format.format(model.getPopulationModel().getSampleFraction()));
