...
public class LayoutUtilityStatistics implements ILayout, IView {
    ...
    public LayoutUtilityStatistics(final Composite parent,
        ...
        ViewStatisticsRTerminal rTerminal = new ViewStatisticsRTerminal(folder.createItem(TAB_RTERMINAL, null, true), controller, target, reset);
        if (target == ModelPart.INPUT) {
            ...
            this.registerView(rTerminal, "help.utility.r");
        } else {
            ...
            //This throws a NullPointer Exception, possibly because these statements are run in parallel
            //this.registerView(new ViewStatisticsRScript(folder.createItem(TAB_RSCRIPT, null, true), controller, target, reset, (ViewStatisticsRTerminal) folder.getButtonItem(TAB_RTERMINAL).getData()), "help.utility.r");
            this.registerView(new ViewStatisticsRScript(folder.createItem(TAB_RSCRIPT, null, true), controller, target, reset, rTerminal), "help.utility.r");
