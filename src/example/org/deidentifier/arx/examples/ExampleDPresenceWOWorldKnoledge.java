...
import org.deidentifier.arx.criteria.DPresenceWOWorldKnowledge;
import org.deidentifier.arx.metric.Metric;

/**
 * This class implements an example on how to apply the d-presence criterion and create a research subset by providing a
 * data subset.
 *
 * @author Fabian Prasser
 * @author Florian Kohlmayer
 */
public class ExampleDPresenceWOWorldKnoledge extends Example {
	...
	public static void main(final String[] args) {
		...
		// config.addCriterion(new DPresence(1d / 3d, 2d / 3d, subset));
		config.addCriterion(new DPresenceWOWorldKnowledge(1d / 3d, 2d / 3d, subset, 20));
