...
public class Example59 extends Example {
	...
	public static void main(String[] args) throws IOException {
		...
		data.getDefinition().setMaskingFunction("Name",
				MaskingFunction.createPermutationFunctionColumns(true, PermutationType.FYKY));
		data.getDefinition().setAttributeType("Surname", AttributeType.IDENTIFYING_ATTRIBUTE);
		data.getDefinition().setMaskingFunction("Surname",
				MaskingFunction.createPermutationFunctionColumns(true, PermutationType.RS));
