...
public final class Configuration implements FLASHConfiguration {
    ...
    public static Configuration getDeserializedConfiguration(final FLASHConfiguration.Criterion criterion,
    ...
    public static Configuration getKAnonymityConfiguration(final double relativeMaxOutliers, final int k) {
        return new Configuration(FLASHConfiguration.Criterion.K_ANONYMITY, 2, relativeMaxOutliers, k);
    }

    public static Configuration getLDiversityConfiguration(final double relativeMaxOutliers, final double c, final int l) {
        return new Configuration(FLASHConfiguration.Criterion.L_DIVERSITY, 4, relativeMaxOutliers, c, l, FLASHConfiguration.LDiversityCriterion.RECURSIVE);
    }

    public static Configuration getLDiversityConfiguration(final double relativeMaxOutliers, final double c, final int l, final FLASHConfiguration.LDiversityCriterion ldivmode) {
        return new Configuration(FLASHConfiguration.Criterion.L_DIVERSITY, 4, relativeMaxOutliers, c, l, ldivmode);
    }

    public static Configuration getLDiversityConfiguration(final double relativeMaxOutliers, final int l, final FLASHConfiguration.LDiversityCriterion ldivmode) {
        return new Configuration(FLASHConfiguration.Criterion.L_DIVERSITY, 4, relativeMaxOutliers, l, ldivmode);
    }

    public static Configuration getTClosenessConfiguration(final double relativeMaxOutliers, final int k, final double t) {
        return new Configuration(FLASHConfiguration.Criterion.T_CLOSENESS, 4, relativeMaxOutliers, k, t);
    }
    ...
    public static Configuration getTClosenessConfiguration(final double relativeMaxOutliers, final int k, final double t, final Hierarchy h) {
        return new Configuration(FLASHConfiguration.Criterion.T_CLOSENESS, 4, relativeMaxOutliers, k, t, h);
    }
    ...
    public static Configuration getDPresenceConfiguration(final double relativeMaxOutliers, final int k, final double dMin, final double dMax, final Set<Integer> researchSubset) {
        return new Configuration(FLASHConfiguration.Criterion.D_PRESENCE, 3, relativeMaxOutliers, k, dMin, dMax, researchSubset);
    }
     ...
     * @param k
     */
    private Configuration(final FLASHConfiguration.Criterion anonymizationMode, final int historyEntryLength, final double relativeMaxOutliers, final int k) {
        criterion = anonymizationMode;
        criterionSpecificSnapshotLength = historyEntryLength;
        this.relativeMaxOutliers = relativeMaxOutliers;
        this.k = k;
     ...
     * @param t
     */
    private Configuration(final FLASHConfiguration.Criterion anonymizationMode, final int historyEntryLength, final double relativeMaxOutliers, final int k, final double t) {
        criterion = anonymizationMode;
        criterionSpecificSnapshotLength = historyEntryLength;
        this.relativeMaxOutliers = relativeMaxOutliers;
     ...
     * @param tclosedist
     */
    private Configuration(final FLASHConfiguration.Criterion anonymizationMode, final int historyEntryLength, final double relativeMaxOutliers, final int k, final double t, final Hierarchy h) {
        criterion = anonymizationMode;
        criterionSpecificSnapshotLength = historyEntryLength;
        this.relativeMaxOutliers = relativeMaxOutliers;
        absoluteMaxOutliersSet = false;
     ...
     */
    @Override
    public final FLASHConfiguration.LDiversityCriterion getLDiversityCriterion() {
     ...
     */
    @Override
    public final FLASHConfiguration.TClosenessCriterion getTClosenessCriterion() {
