...
import org.deidentifier.flash.framework.BitSetCompressed;
...
public class HashGroupify implements IHashGroupify {
     ...
     * 
     * @see
     * org.deidentifier.flash.framework.check.groupify.IHashGroupify#add(int[],
     * int, int)
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.deidentifier.flash.framework.check.groupify.IHashGroupify#addD(int[], int, int, int)
     */
    @Override
     ...
     * org.deidentifier.flash.framework.check.groupify.IHashGroupify#add(int[],
     * int, int,
     * org.deidentifier.flash.framework.check.distribution.Distribution)
     */
    @Override
     ...
     * 
     * @see
     * org.deidentifier.flash.framework.check.groupify.IHashGroupify#clear()
     */
    @Override
    public void clear() {
        if (elementCount > 0) {
     ...
     * 
     * @see
     * org.deidentifier.flash.framework.check.groupify.IHashGroupify#getFirstEntry
     * ()
     */
    @Override
     ...
     * 
     * @see
     * org.deidentifier.flash.framework.check.groupify.IHashGroupify#isAnonymous
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see org.deidentifier.flash.framework.check.groupify.IHashGroupify#size()
     */
    @Override
    public int size() {
        return elementCount;
