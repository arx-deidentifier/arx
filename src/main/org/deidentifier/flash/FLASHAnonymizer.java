...
import org.deidentifier.flash.algorithm.AbstractAlgorithm;
import org.deidentifier.flash.algorithm.FLASHAlgorithm;
import org.deidentifier.flash.algorithm.FLASHStrategy;
...
import org.deidentifier.flash.framework.lattice.LatticeBuilder;
import org.deidentifier.flash.metric.Metric;

/**
 * This class offers several methods to define parameters and execute the FLASH
 * algorithm.
 * 
 * @author Prasser, Kohlmayer
 */
public class FLASHAnonymizer {

    /**
     * Temporary result of the flash algorithm.
     * 
     * @author Prasser, Kohlmayer
     */
    class Result {
     ...
     *            the snapshot size
     */
    public FLASHAnonymizer(final int historySize, final double snapshotSize) {
     ...
     *            the metric
     */
    public FLASHAnonymizer(final int historySize, final double snapshotSize, final Metric<?> metric) {
        this.historySize = historySize;
        snapshotSizeDataset = snapshotSize;
        this.metric = metric;
    }
     ...
     */
    public FLASHAnonymizer(final int historySize, final double snapshotSize, final Metric<?> metric, final String suppressionString) {
     ...
     *            the relativeMaxOutliers string
     */
    public FLASHAnonymizer(final int historySize, final double snapshotSize, final String suppressionString) {
        this.historySize = historySize;
        snapshotSizeDataset = snapshotSize;
        this.suppressionString = suppressionString;
    }
     ...
     *            the metric
     */
    public FLASHAnonymizer(final Metric<?> metric) {
        this.metric = metric;
    }
     ...
     *            the relativeMaxOutliers string
     */
    public FLASHAnonymizer(final Metric<?> metric, final String suppressionString) {
        this.metric = metric;
        this.suppressionString = suppressionString;
    }
     ...
     *            the relativeMaxOutliers string
     */
    public FLASHAnonymizer(final String suppressionString) {
        this.suppressionString = suppressionString;
    }
    ...
    /**
     * Internal method that executes the FLASH algorithm.
     * 
     * @param manager
     *            the data manager
     * @param config
     *            the config
     * @return the FLASH result internal
     * @throws IOException
     */
    protected FLASHResult anonymizeInternal(final Data data, final Configuration config) throws IOException {
     ...
     */
    public FLASHResult kAnonymize(final Data data, final int k, final double maxOutliers) throws IllegalArgumentException, IOException {

        if (data == null) { throw new NullPointerException("Data cannot be null!"); }
        final Configuration config = Configuration.getKAnonymityConfiguration(maxOutliers, k);
        final FLASHResult result = anonymizeInternal(data, config);
        return result;
    }
     ...
     *             Signals that an I/O exception has occurred.
     */
    public FLASHResult lDiversify(final Data data, final double c, final int l, final double maxOutliers) throws IllegalArgumentException, IOException {
     ...
     *             Signals that an I/O exception has occurred.
     */
    public FLASHResult lDiversify(final Data data, final int l, final boolean entropy, final double maxOutliers) throws IllegalArgumentException, IOException {

        if (data == null) { throw new NullPointerException("Data cannot be null!"); }
        Configuration config = null;
        if (entropy) {
            config = Configuration.getLDiversityConfiguration(maxOutliers, l, FLASHConfiguration.LDiversityCriterion.ENTROPY);
        } else {
            config = Configuration.getLDiversityConfiguration(maxOutliers, l, FLASHConfiguration.LDiversityCriterion.DISTINCT);
        }
     ...
     *             Signals that an I/O exception has occurred.
     */
    public FLASHResult tClosify(final Data data, final int k, final double t, final double maxOutliers) throws IllegalArgumentException, IOException {
     ...
     *             Signals that an I/O exception has occurred.
     */
    public FLASHResult tClosify(final Data data, final int k, final double t, final double maxOutliers, final Hierarchy hierarchy) throws IllegalArgumentException, IOException {
     ...
     *             Signals that an I/O exception has occurred.
     */
    public FLASHResult dpresencify(final Data data, final int k, final double dMin, final double dMax, final double maxOutliers, final Set<Integer> researchSubset) throws IllegalArgumentException,
                                                                                                                                                                   IOException {
