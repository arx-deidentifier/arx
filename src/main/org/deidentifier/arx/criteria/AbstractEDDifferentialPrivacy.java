...
public abstract class AbstractEDDifferentialPrivacy extends ImplicitPrivacyCriterion {
     ...
     * @return
     */
    protected double calculateBeta(double epsilon) {
     ...
     * @return
     */
    protected int calculateK(double delta, double epsilon, double beta) {
        int k = 1;
