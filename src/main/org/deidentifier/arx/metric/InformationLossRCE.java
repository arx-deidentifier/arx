 ...
 * of individual utility for each attribute. Instances are compared with repeated
...
class InformationLossRCE extends InformationLoss<double[]> {
    ...
    public double relativeTo(InformationLoss<?> min, InformationLoss<?> max) {
        ...
        double result = (perc - _min.perc) / (_max.perc - _min.perc); // TODO
        return result >= 0d ? (result <=1d ? result : 1d) : 0d; // TODO
