 ...
 */
public class MultiClassSVMClassificationResult implements ClassificationResult {
     ...
     * @param map
     */
    MultiClassSVMClassificationResult(int result, double[] probabilities, Map<String, Integer> map) {
        this.map = map;
