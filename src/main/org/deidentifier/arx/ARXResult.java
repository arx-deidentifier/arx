...
public interface ARXResult {
     ...
     */
    public abstract ARXNode getGlobalOptimum();
     ...
     * @return
     */
    public abstract DataHandle getHandle(ARXNode node);
     ...
     * @return
     */
    public abstract ARXLattice getLattice();
