...
public class NodeChecker {
     ...
     * @return
     */
    public double getScore(Transformation transformation, Metric<?> metric, int k, int numRecords) {
        apply(transformation);
        return metric.getScore(transformation, currentGroupify, k, numRecords);
    }
}
