...
public class Transformer15 extends AbstractTransformer {
    ...
    protected void processAll() {
        for (int i = startIndex; i < stopIndex; i++) {
            ...
            buffer.setValueAtColumn(index10, idindex10[data.getValueAtColumn(index10)][generalizationindex10]);
            buffer.setValueAtColumn(index11, idindex11[data.getValueAtColumn(index11)][generalizationindex11]);
            buffer.setValueAtColumn(index12, idindex12[data.getValueAtColumn(index12)][generalizationindex12]);
            buffer.setValueAtColumn(index13, idindex13[data.getValueAtColumn(index13)][generalizationindex13]);
            buffer.setValueAtColumn(index14, idindex14[data.getValueAtColumn(index14)][generalizationindex14]);
