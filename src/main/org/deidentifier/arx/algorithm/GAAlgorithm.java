...
public class GAAlgorithm extends AbstractAlgorithm {
	...
	public static AbstractAlgorithm create(SolutionSpace<?> solutionSpace, TransformationChecker checker,
			...
			double geneticAlgorithmMutationProbability, int geneticAlgorithmSubpopulationSize, double geneticAlgorithmpProductionFraction, 
			int timeLimit, int checkLimit) {
		return new GAAlgorithm(solutionSpace, checker, heuristicSearchStepLimit, geneticAlgorithmCrossoverFraction,
				...
				geneticAlgorithmSubpopulationSize, geneticAlgorithmpProductionFraction, timeLimit, checkLimit);
	}
	...
	public GAAlgorithm(SolutionSpace<?> solutionSpace, TransformationChecker checker, int geneticAlgorithmIterations,
			...
			int geneticAlgorithmSubpopulationSize, double geneticAlgorithmpProductionFraction, int timeLimit, int checkLimit) {
	...
	private void iterateSubpopulation(GASubpopulation population) {
		...
		// - Second: a crossover fraction of individuals will be generated by crossing parent instances from the old population
        // - Third: the remaining populated will be populated by mutated individuals
